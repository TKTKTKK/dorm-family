...
!function(d){var h=function(a){this.messages={defaultMessage:"该项输入不合法.",type:{email:"该项应该输入合法邮箱.",url:"该项应该输入合法url.",urlstrict:"该项应该输入合法url.",number:"该项应该输入数值.",digits:"该项应该输入数字.",dateIso:"该项应该输入合法日期 (yyyy-mm-dd).",alphanum:"该项只能输入字母、数字和下划线.",phone:"该项应该输入合法号码."},notnull:"This value should not be null.",
    notblank:"该项不能为空.",required:"该项为必填项.",regexp:"该项输入不合法.",min:"该值必须大于或等于1.",max:"该项最大长度不能超过 %s.",range:"This value should be between %s and %s.",minlength:"This value is too short. It should have %s characters or more.",maxlength:"该项最大输入长度不能超过 %s 个字符.",rangelength:"This value length is invalid. It should be between %s and %s characters long.",
    mincheck:"You must select at least %s choices.",maxcheck:"You must select %s choices or less.",rangecheck:"You must select between %s and %s choices.",equalto:"确认密码应该与密码一致."};this.init(a)};h.prototype={constructor:h,validators:{notnull:function(a){return 0<a.length},notblank:function(a){return"string"===typeof a&&""!==a.replace(/^\s+/g,"").replace(/\s+$/g,"")},required:function(a){if("object"===typeof a){for(var b in a)if(this.required(a[b]))return!0;return!1}return this.notnull(a)&&
