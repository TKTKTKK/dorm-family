...
<header class="panel-heading">
    卡券 》 查询卡券 》 <span class="font-bold text-black"> 卡券详情</span>
</header>
<div class="row">
<div class="col-sm-12">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <select data-required="true" class="form-control" id="sltcard_type" onchange="selectCartType(this)">
                <c:if test="${wechatBaseCard.card_type == 'MEMBER_CARD'}">
            ...
            <div class="btn-group" style="width: 100%">
                <button type="button" class="btn btn-default" onclick="showOrHidInfoDiv('baseInfo','consumSet','detailInfo','fitBusiness')" id="cardBtn"
                    ...
                    <div class="row" style="height: 200px">
                        <div class="col-sm-2">
                            <img src="${web:getFileViewUrl(wechatBaseCard.logo_url)}" width="50" height="50">
                        </div>
                        <div class="col-sm-5">
                            <H4><b>${wechatBaseCard.brand_name}</b></H4>
                        </div>
                        <div class="col-sm-5">
                        </div>
                        <div class="col-sm-12 font-bold top-margin-twenty" id="titleForCard">${wechatBaseCard.title}</div>
                        <div class="col-sm-12 font-normal top-margin-twenty" id="sub_titleForCard">${wechatBaseCard.sub_title}</div>
                        <div class="col-sm-12 font-normal top-margin-twenty" id="noticeForCard">操作提示：${wechatBaseCard.notice}</div>
                    </div>
                </button>
            </div>
        </div>
                ...
                <button type="button" class="btn btn-default" onclick="showOrHidInfoDiv('consumSet','baseInfo','detailInfo','fitBusiness')" id="consumSetBtn"
                    ...
                    <div class="col-sm-11">
                        ...
                        <div class="col-sm-12 hide-element" id="consumSetQrcode">
                            <c:if test="${not empty wechatBaseCard.ticket}">
                                <img src="https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=${wechatBaseCard.ticket}" width="100" height="100">
                            </c:if>
                            <c:if test="${empty wechatBaseCard.ticket}">
                                <img src="${ctx}/static/admin/img/qrcode.png" width="100" height="100">
                            </c:if>
                        </div>
...
<div class="col-sm-8">
<form class="form-horizontal" data-validate="parsley" action="${ctx}/admin/card/cardInfo" method="post" onsubmit="return showAllInfoDiv()" id="cardForm">
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="control-label" style="padding-top: 4px">${wechatBaseCard.brand_name}</label>
                        <input type="hidden" name="brand_name" value="${wechatBaseCard.brand_name}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="col-sm-12 navbar-left" style="padding-left: 0px">
                            <img src="${web:getFileViewUrl(wechatBaseCard.logo_url)}" width="50" height="50">
                            <input type="hidden" name="logo_url" value="${wechatBaseCard.logo_url}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select data-required="true" class="form-control" id="color" name="color" onchange="selectColor()">
                            <option value="" style="background-color: #ffffff" >请选择颜色</option>
                            <c:forEach items="${commonCodeList}" var="commonCode">
                                <c:if test="${commonCode.code == wechatBaseCard.color}">
                                    <option value="${commonCode.code}-${commonCode.codevalue}" style="background-color: ${commonCode.codevalue}" selected></option>
                                </c:if>
                                <c:if test="${commonCode.code != wechatBaseCard.color}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="title" class="form-control" id="title" data-required="true" data-maxlength="18" onblur="setTitleAndSubTitle(this, 'titleForCard', 18, 'titleError')"
                               value="${wechatBaseCard.title}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="sub_title" class="form-control" data-maxlength="36" id="sub_title" value="${wechatBaseCard.sub_title}"
                    ...
                    <div class="col-sm-9">
                        <div class="radio row">
                            <label class="col-sm-2 control-label"  style="text-align: left;padding-top: 4px">
                                <c:if test="${wechatBaseCard.type == 1}">
                                    <input type="radio" name="type" id="type1" value="1"  onclick="compareBeginEndDate()" checked>
                                </c:if>
                                <c:if test="${wechatBaseCard.type != 1}">
                                    <input type="radio" name="type" id="type1" value="1"  onclick="compareBeginEndDate()">
                                </c:if>
                                <span>固定日期，</span>
                            </label>
                            <label class="col-sm-1 control-label" style="padding-top: 4px">从</label>
                            <input class="input-sm input-s datepicker-input form-control col-sm-4" size="16" type="text" data-type="dateIso" name="begin_timestampstr"  value="${wechatBaseCard.begin_timestampstr}"
                            ...
                            <input class="input-sm input-s datepicker-input form-control col-sm-4" size="16" type="text" data-type="dateIso" name="end_timestampstr"  value="${wechatBaseCard.end_timestampstr}"
                        ...
                        <div class="radio row" style="margin-top: 20px">
                            <label class="col-sm-2 control-label" style="text-align: left;padding-top: 4px">
                                <c:if test="${wechatBaseCard.type == 2}">
                                    <input type="radio" name="type" id="type2" value="2" onclick="compareBeginEndDate()" checked>
                                </c:if>
                                <c:if test="${wechatBaseCard.type != 2}">
                                    <input type="radio" name="type" id="type2" value="2" onclick="compareBeginEndDate()">
                                </c:if>
                                领取后,
                            </label>
                            <select data-required="true" class="input-sm input-s-sm form-control col-sm-2" name="fixed_begin_term">
                                <c:forEach items="${beginTermList}" var="beginTerm">
                                    <c:if test="${beginTerm == wechatBaseCard.fixed_begin_term}">
                                        <option value="${beginTerm}" selected>
                            ...
                            <select data-required="true" class="input-sm input-s-sm form-control col-sm-2" name="fixed_term">
                                <c:forEach items="${fixedTermList}" var="fixedTerm">
                                    <c:if test="${fixedTerm == wechatBaseCard.fixed_term}">
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div>
                            <input type="text" name="quantity" class="form-control input-s-lg col-sm-8" data-required="true" data-maxlength="64"
                                   onblur="trimText(this),validQuantity(),compareGetLimitAndQuantity()" id="quantity" value="${wechatBaseCard.quantity}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div>
                            <input type="text" name="get_limit" class="form-control input-s-lg col-sm-8" data-maxlength="64"
                                   onblur="trimText(this),compareGetLimitAndQuantity()"
                                   id="get_limit" value="${wechatBaseCard.get_limit}">
                ...
                <div class="checkbox i-checks">
                    ...
                    <label class="col-sm-10">
                        <c:if test="${wechatBaseCard.can_share == 'Y'}">
                            <input type="checkbox" name="can_share" checked><i></i> 用户可以分享领券链接
                        </c:if>
                        <c:if test="${wechatBaseCard.can_share != 'Y'}">
                            <input type="checkbox" name="can_share"><i></i> 用户可以分享领券链接
                        </c:if>
                    </label>
                </div>
                <c:if test="${wechatBaseCard.card_type != 'MEMBER_CARD'}">
                    <div class="checkbox i-checks">
                        <label class="col-sm-2"></label>
                        <label class="col-sm-10">
                            <c:if test="${wechatBaseCard.can_give_friend == 'Y'}">
                                <input type="checkbox" name="can_give_friend" checked><i></i> 用户领券后可转赠其他好友
                            </c:if>
                            <c:if test="${wechatBaseCard.can_give_friend != 'Y'}">
                                <input type="checkbox" name="can_give_friend"><i></i> 用户领券后可转赠其他好友
                            </c:if>
                        </label>
                    </div>
                </c:if>
        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label class="col-sm-12">
                                <c:if test="${wechatBaseCard.code_type == 'CODE_TYPE_TEXT'}">
                                    <input type="radio" name="code_type" id="code_type1" value="CODE_TYPE_TEXT" onclick="showConsumTypeForCard('CODE_TYPE_TEXT')" checked>
                                </c:if>
                                <c:if test="${wechatBaseCard.code_type != 'CODE_TYPE_TEXT'}">
                                    <input type="radio" name="code_type" id="code_type1" value="CODE_TYPE_TEXT" onclick="showConsumTypeForCard('CODE_TYPE_TEXT')">
                                </c:if>
                                <b>仅卡券号</b>
                            </label>
                            <label class="col-sm-12">
                        ...
                        <div class="radio" style="margin-top: 20px">
                            <label class="col-sm-12">
                                <c:if test="${wechatBaseCard.code_type == 'CODE_TYPE_QRCODE'}">
                                    <input type="radio" name="code_type" id="code_type2" value="CODE_TYPE_QRCODE" onclick="showConsumTypeForCard('CODE_TYPE_QRCODE')" checked>
                                </c:if>
                                <c:if test="${wechatBaseCard.code_type != 'CODE_TYPE_QRCODE'}">
                                    <input type="radio" name="code_type" id="code_type2" value="CODE_TYPE_QRCODE" onclick="showConsumTypeForCard('CODE_TYPE_QRCODE')">
                                </c:if>
                                <b>二维码</b>
                            </label>
                            <label class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="notice" class="form-control" data-maxlength="32" data-required="true"
                               onblur="setNoticeForCard(this, 'noticeForCard', 32, 'noticeError')"
                               id="notice" value="${wechatBaseCard.notice}">
            ...
            <div class="panel-body">
                <c:if test="${wechatBaseCard.card_type == 'MEMBER_CARD'}">
                    <div class="checkbox i-checks">
                        <label class="col-sm-2"></label>
                        <label class="col-sm-10">
                            <c:if test="${wechatBaseCard.supply_bonus == 'Y'}">
                                <input type="checkbox" name="supply_bonus" id="member_card.supply_bonus" onclick="validBonus()" checked><i></i> 支持积分
                            </c:if>
                            <c:if test="${wechatBaseCard.supply_bonus != 'Y'}">
                                <input type="checkbox" name="supply_bonus" id="member_card.supply_bonus" onclick="validBonus()"><i></i> 支持积分
                            </c:if>
                        </label>
                    </div>
                    <div class="checkbox i-checks hidden">
                        <label class="col-sm-2"></label>
                        <label class="col-sm-10">
                            <c:if test="${wechatBaseCard.supply_balance == 'Y'}">
                                <input type="checkbox" name="supply_balance" id="member_card.supply_balance" onclick="validBalanceRule()" checked><i></i> 支持储值
                            </c:if>
                            <c:if test="${wechatBaseCard.supply_balance != 'Y'}">
                                <input type="checkbox" name="supply_balance" id="member_card.supply_balance" onclick="validBalanceRule()"><i></i> 支持储值
                            </c:if>
                        </label>
                    </div>
                    <div class="line line-dashed b-b line-lg pull-in"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="6" name="bonus_cleared" id="bonus_cleared"  data-maxlength="2000"
                                      onblur="validBonus(), validateChineseTextForTwo(2000, this, 'bonus_clearedError')">${wechatBaseCard.bonus_cleared}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="6" name="bonus_rules" id="bonus_rules"  data-maxlength="2000"
                                      onblur="validBonus(), validateChineseTextForTwo(2000, this, 'bonus_rulesError')">${wechatBaseCard.bonus_rules}</textarea>
                    ...
                    <div class="form-group hidden">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="6" name="balance_rules" id="balance_rules"  data-maxlength="2000"
                                      onblur="validBalanceRule(), validateChineseTextForTwo(2000, this, 'balance_rulesError')">${wechatBaseCard.balance_rules}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="6" name="prerogative" id="prerogative" data-required="2000" data-maxlength="2000"
                                      onblur="validateChineseTextForTwo(2000, this, 'prerogativeError')">${wechatBaseCard.prerogative}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="bind_old_card_url" data-type="url" class="form-control" data-maxlength="255" id="bind_old_card_url" value="${wechatBaseCard.bind_old_card_url}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="activate_url" data-type="url" class="form-control" data-maxlength="255" id="activate_url" value="${wechatBaseCard.activate_url}"
                                   onblur="trimText(this),validateBindActiveUrl()">
                        </div>
                    </div>
                    <div>
                ...
                <c:if test="${wechatBaseCard.card_type != 'MEMBER_CARD'}">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" rows="6" name="detail" id="default_detail" data-required="2000" data-maxlength="2000"
                                      onblur="validateChineseTextForTwo(2000, this, 'default_detailError')">${wechatBaseCard.detail}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="6" name="description" id="description" data-required="true" data-maxlength="2000"
                                  onblur="validateChineseTextForTwo(2000, this, 'descriptionError')">${wechatBaseCard.description}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="service_phone" class="form-control" data-type="phone" placeholder="(XXX) XXXX XXX" onblur="trimText(this)" value="${wechatBaseCard.service_phone}">
                    </div>
                </div>
...
<div>
    <input type="hidden" name="card_type" value="${wechatBaseCard.card_type}" id="hidcard_type">
    <input type="hidden" name="uuid" value="${wechatBaseCard.uuid}">
    <input type="hidden" name="versionno" value="${wechatBaseCard.versionno}">
    <input type="hidden" name="card_id" value="${wechatBaseCard.card_id}">
</div>
...
function submitCard(){
    ...
    code_typeError.innerHTML = '';
    //判断销券方式是否已选
    var code_types = document.getElementsByName('code_type');
    var selectedType = '';
...
//销券方式
showConsumTypeForCard('${wechatBaseCard.code_type}');
</script>
</body>
</html>
