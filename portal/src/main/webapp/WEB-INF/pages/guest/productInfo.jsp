...
<ul class="list">
    ...
    <li>
        <span>出厂编号</span>
        <input type="text" id="machineno" name="machineno" value="${machine.machineno}" placeholder="请填写出厂编号">
    </li>
    <li>
        <span>汽油机出厂编号</span>
        <input type="text" id="engineno" name="engineno" value="${machine.engineno}" placeholder="请填写汽油机出厂编号">
    </li>
</ul>
...
<script type="text/javascript">
    ...
    function submitForm(){
        ...
        if(model.length>0 &&name.length>0&&machineno.length>0&&engineno.length>0){
            var searchForm=document.getElementById("searchForm");
            searchForm.action="${ctx}/guest/productInfo";
            searchForm.submit();
        }else{
