...
<head>
    ...
    <style>
        ...
        #consultImgContainer{display: inline-block;vertical-align: middle}
        #consultImgUrlContainer{display: inline-block;vertical-align: middle;margin-left: 2rem}
        #consultImgContainer img{width: 50px;height: 50px;margin:1rem;max-width: none}
...
<body>
    <div class="head">
        <a class="back" href="${ctx}/guest/consult_list?stuId=${student.uuid}"></a>
        <span>咨询</span>
    </div>

        <form class="form-horizontal form-bordered" data-validate="parsley"
              action="${ctx}/guest/consult_add" method="POST" id="frm">
            <ul class="list">
                <li>
                    ...
                    <input type="text" id="stuid" name="stuid" class="hidden" value="${student.uuid}" readonly
                           data-required="true" data-maxlength="32" onblur="trimText(this)"/>
                </li>
                <li>
        ...
        <a href="javascript:submitconsultInfo()">
            <div class="fixsubmit">
                    提交
            </div>
        </a>
...
<script type="text/javascript">
    ...
    function submitconsultInfo(){
        ...
        if(detailError == ""){
            ...
            errorMessage.innerHTML = detailError;
    ...
    $('.pageUpload').change(function () {
        if ($(".pageUpload").attr("readonly") == "readonly") {
            ...
            compressUploadPicture(document.getElementById("consultImg"));
        }
    });
