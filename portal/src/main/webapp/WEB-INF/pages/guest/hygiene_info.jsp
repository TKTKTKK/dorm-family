...
<body>
    <div class="head">
        <a class="back" href="${ctx}/guest/hygiene_list?stuId=${stuId}"></a>
        <span>卫生详情</span>
    </div>
            ...
            <ul class="list" id="machineUl">
                <li>
                    <span>打分日期</span>
                    <input type="text" id="createon" name="createon" value="${fn:substring(hygiene.createon, 0, 11)}"
                           data-required="true"  data-maxlength="32" readonly/>
                </li>
                <li>
                    <span>地面</span>
                    <input type="text"  value="${hygiene.ground}"
                           data-required="true"  data-maxlength="32" readonly/>
                </li>
                <li>
                    <span>桌面</span>
                    <input type="text"  value="${hygiene.desk}"
                           data-required="true"  data-maxlength="32" readonly/>
                </li>
                <li>
                    <span>床褥</span>
                    <input type="text"  value="${hygiene.bed}"
                           data-required="true"  data-maxlength="32" readonly/>
                </li>
                <li>
                    <span>阳台</span>
                    <input type="text"  value="${hygiene.balcony}"
                           data-required="true"  data-maxlength="32" readonly/>
                </li>
                <li>
                    <span>卫生间</span>
                    <input type="text"  value="${hygiene.toilet}"
                           data-required="true"  data-maxlength="32" readonly/>
                </li>
                <li>
                    <span>总分</span>
                    <input type="text"  value="${hygiene.total}"
                           data-required="true"  data-maxlength="32" readonly/>
                </li>
