...
<div class="content">
    <ul class="list">
        <c:forEach items="${hygieneList}" var="hygiene">
            <a href="${ctx}/guest/hygiene_info?hygieneId=${hygiene.uuid}&stuId=${stuId}">
                <li>
                    <p>
                        <span>第${hygiene.week}周</span>
                            ${hygiene.total}

                    </p>
                    <p><span class="time">${fn:substring(hygiene.createon, 0, 16)}</span></p>
                </li>
            </a>
        </c:forEach>
