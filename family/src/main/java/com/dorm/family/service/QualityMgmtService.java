...
import com.dorm.family.mapper.QualityMgmtMapper;
...
public class QualityMgmtService extends BaseService<QualityMgmtMapper,QualityMgmt> {
    ...
    public List<QualityMgmt> queryQualityMgmtAsy(QualityMgmt qualityMgmt) {
        return this.mapper.selectQualityMgmtAsy(qualityMgmt);
    }
}
